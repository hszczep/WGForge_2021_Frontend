...
import { fetchIP } from './ts/fetch-module';
...
const currenciesContainer = document.querySelector('#ipInfo');

// Test an async(fetch) operation
const render = async (container: Element, fetchToAPIMethod: () => Promise<any>) => {
...
render(currenciesContainer, fetchIP);
