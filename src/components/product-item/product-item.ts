class productItemComponent {
  ...
  card_flag=''; // item flag (optional) __ (flag__china, flag__czech, flag__france, flag__germany, flag__poland, flag__sweden, flag__uk, flag__usa, flag__ussr)
  card_type=''; // item type (optional) __ (type__at-spg, type__heavytank, type__lighttank, type__mediumtank, type__multirole, type__spg)
            ...
            <a href="${(this.card_href)}" class="card-info">
              ...
              <div class="card-specifications">
                ...
                <h2 class="item-text">
                  ...
                  <span class="type ${this.card_type}"></span>
