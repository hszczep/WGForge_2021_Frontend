    ...
    return `
      <div class="content-field">
        <div class="content-menu">
          <a href="#"><img src="assets/images/WoT_logo.png" alt="WoT logo" /></a>
            ...
            <a href="#" class="card-info">
              ...
              <div class="card-specifications">
                ...
                <h2 class="item-text">
                  ...
                  <span class="type type__at-spg"></span>
            ...
            <a href="#" class="card-info">
              ...
              <div class="card-specifications">
                ...
                <h2 class="item-text">
                  ...
                  <span class="type type__heavytank"></span>
            ...
            <a href="#" class="card-info">
              ...
              <div class="card-specifications">
                ...
                <h2 class="item-text">
                  ...
                  <span class="type type__lighttank"></span>
            ...
            <a href="#" class="card-info">
              ...
              <div class="card-specifications">
                ...
                <h2 class="item-text">
                  ...
                  <span class="type type__multirole"></span>
                  <span class="level">III</span>
                  <span class="item-name">ИС-9</span>
                </h2>
                <p class="price">$ 100.03</p>
              </div>
            </a>
            <button class="like-btn">
              <svg class="like-btn__icon">
            ...
            <a href="#" class="card-info">
              ...
              <div class="card-specifications">
                ...
                <h2 class="item-text">
                  ...
                  <span class="type type__mediumtank"></span>
